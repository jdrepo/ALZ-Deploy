...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/jdrepo/ALZ-Deploy/main/infra-as-code/bicep/modules/identity/scripts/Add-DomainServices.ps1.zip" -OutFile "Add-DomainServices.ps1.zip"
