...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/jdrepo/ALZ-Deploy/main/infra-as-code/bicep/modules/onprem/scripts/prepareDisks.ps1" -OutFile "prepareDisks.ps1"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/jdrepo/ALZ-Deploy/main/infra-as-code/bicep/modules/onprem/scripts/Deploy-DomainServices.ps1.zip" -OutFile "Deploy-DomainServices.ps1.zip"
